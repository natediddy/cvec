...
#define cvec_push_front(__v, __item)                                          \
  ...
  {                                                                           \
    __cvec_maybe_grow(__v);                                                   \
    memcpy((__v).__data + 1, (__v).__data, (__v).__t * (__v).__n++);          \
    (__v).__data[0] = (__item);                                               \
  } while (0)
...
#define cvec_pop_front(__v)                                                   \
  ...
  {                                                                           \
    ...
    {                                                                         \
      if ((__v).__on_free)                                                    \
        (__v).__on_free((__v).__data[0]);                                     \
      memcpy((__v).__data, (__v).__data + 1, (__v).__t * --(__v).__n);        \
    }                                                                         \
  } while (0)
 ...
 */
#define cvec_get(__v, __i) (__v).__data[(__i)]
...
#define cvec_at(__v, __i)                                                     \
  ((__i) < (__v).__n) ? (__v).__data[(__i)] : (__v).__sentinel
